...
if "%VERSION:~0,2%"=="11" (
    node %~dp0\node-script\do-gitpatch.js -p %GITHUB_WORKSPACE%\patches\export_contextual.patch
)
...
echo =====[ Building V8 ]=====
call gn gen out.gn\x64.release -args="target_os=""win"" target_cpu=""x64"" v8_enable_sandbox=false v8_use_external_startup_data=false v8_enable_i18n_support=false is_debug=false is_clang=false strip_debug_info=true symbol_level=0 v8_enable_pointer_compression=true is_component_build=true"

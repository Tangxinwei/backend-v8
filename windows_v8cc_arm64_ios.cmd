...
set GN_ARGS=target_os=""win"" target_cpu=""arm64"" v8_use_external_startup_data=false v8_enable_i18n_support=false is_debug=false v8_static_library=true is_clang=true use_custom_libcxx=true v8_enable_sandbox=false v8_enable_webassembly=false
